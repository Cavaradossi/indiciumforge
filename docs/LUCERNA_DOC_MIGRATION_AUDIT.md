...
| Daily-review CLI + manifest audit v0.4.1 | carry_forward | ADR-0014 + lucerna artifact list/audit |
| Synthetic E2E workflow v0.5-alpha | carry_forward | ADR-0015 + lucerna_workflow.e2e.synthetic |
