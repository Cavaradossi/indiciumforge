...
\begin{enumerate}[leftmargin=*]
  ...
  \item Real quant capability: four ports--analytics, portfolio, backtest, pricing--with reference adapters, an A-share golden snapshot, and a deterministic end-to-end pipeline behind \texttt{indiciumforge quant}.\claim{C43-C51, ADR-0026}
\end{enumerate}
...
\texttt{[data]} (akshare, lxml) extras.\claim{C44-C47, ADR-0026} The end-to-end pipeline
...
Static and unit gates & Ruff in CI; pytest reported 241 passed and 1 skipped at draft time & C19, C20 \\
...
Governance & 25 ADRs plus anti-inheritance rules and agent onboarding documents & C29, C32, C33 \\
\bottomrule
\end{tabularx}
...
They are computed on the synthetic golden panel and demonstrate \emph{framework correctness
...
\end{verbatim}
At draft time the public suite reported 241 passing tests and one skipped test. The parity
...
synthetic golden panel.\claim{C49,C50}
