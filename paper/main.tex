...
agent-friendly governance, and real quant capability behind four audited ports. A three-layer
...
\paragraph{Reference quant pipeline on the synthetic golden panel.}
...
risk 0.00861, Sharpe 0.322 (long-only, weight bounds). The vectorized backtest
