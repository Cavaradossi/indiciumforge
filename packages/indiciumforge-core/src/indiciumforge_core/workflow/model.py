...
WORKFLOW_RECIPE_SCHEMA = "indiciumforge.workflow_recipe.v1"
WORKFLOW_CHECKPOINT_SCHEMA = "indiciumforge.workflow_checkpoint.v1"
EVIDENCE_STAGE_REF_SCHEMA = "indiciumforge.evidence_stage_ref.v1"
